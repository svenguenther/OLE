        ...
        "theory": {
            "classy": {
                ...
                'emulator_settings': {
                    ...
                    'cache_file': './cobaya_spt_out_OLE/cache.pkl',
                    'output_directory': './cobaya_spt_out_OLE/output',
                    ...
                    'N_quality_samples': 5,
                    'logfile': './cobaya_spt_out_OLE/logfile.txt',

                    # plotting dir
                    # 'plotting_directory': './cobaya_spt_out_OLE/plots',
        ...
        "mcmc": {
            ...
            "blocking":
                [[1, ["logA", "n_s", "omega_b", "omega_cdm", "tau_reio", "h",]],
                 [1, ["EE_Poisson_150x150", "EE_Poisson_150x220", "EE_Poisson_220x220", "EE_Poisson_90x150", "EE_Poisson_90x220", "EE_Poisson_90x90", "EE_PolGalDust_Alpha", "EE_PolGalDust_Amp", "EE_PolGalDust_Beta", "Ecal150", "Ecal220", "Ecal90", "Kappa", "TE_PolGalDust_Alpha", "TE_PolGalDust_Amp", "TE_PolGalDust_Beta", "TT_CIBClustering_Amp", "TT_CIBClustering_Beta", "TT_GalCirrus_Alpha", "TT_GalCirrus_Amp", "TT_GalCirrus_Beta", "TT_Poisson_150x150", "TT_Poisson_150x220", "TT_Poisson_220x220", "TT_Poisson_90x150", "TT_Poisson_90x220", "TT_Poisson_90x90", "TT_kSZ_Amp", "TT_tSZ_Amp", "TT_tSZ_CIB_Corr_Amp", "Tcal150", "Tcal220", "Tcal90"]]],
            },
        },
        'output': './cobaya_spt_out_OLE/spt',
        # 'debug': True,
        'force': True,
        'resume':False,
        'test': False,
