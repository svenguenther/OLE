...
my_parameters = {'h': {'prior': {'min': 0.60, 'max': 0.80}, 
                    ...
                    'EE_Poisson_150x150': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.040469, 'std': 0.003448}, 
                                           'ref': {'mean': 0.040469, 'std': 0.003448}, 
                                           'proposal': 0.003448},
                    'EE_Poisson_150x220': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.018962, 'std': 0.005689}, 
                                           'ref': {'mean': 0.018962, 'std': 0.005689}, 
                                           'proposal': 0.005689},
                    'EE_Poisson_220x220': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.047557, 'std': 0.014267}, 
                                           'ref': {'mean': 0.047557, 'std': 0.014267}, 
                                           'proposal': 0.014267},
                    'EE_Poisson_90x150': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.018048, 'std': 0.005414}, 
                                          'ref': {'mean': 0.018048, 'std': 0.005414}, 
                                          'proposal': 0.005414},
                    'EE_Poisson_90x220': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.015719, 'std': 0.004716}, 
                                          'ref': {'mean': 0.015719, 'std': 0.004716},
                                            'proposal': 0.004716},
                    'EE_Poisson_90x90': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.040469, 'std': 0.012141}, 
                                         'ref': {'mean': 0.040469, 'std': 0.012141},
                                           'proposal': 0.012141},
                    'EE_PolGalDust_Alpha': {'prior': {'min': -10.0, 'max': 1.0, 'mean': -2.42, 'std': 0.04}, 
                                            'ref': {'mean': -2.42, 'std': 0.04},
                                              'proposal': 0.04},
                    'EE_PolGalDust_Amp': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.05, 'std': 0.022}, 
                                          'ref': {'mean': 0.05, 'std': 0.022}, 
                                          'proposal': 0.022},
                    'EE_PolGalDust_Beta': {'prior': {'min': -1.0, 'max': 10.0, 'mean': 1.51, 'std': 0.04}, 
                                           'ref': {'mean': 1.51, 'std': 0.04},
                                             'proposal': 0.04},
                    'Kappa': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.0, 'std': 0.00045}, 
                              'ref': {'mean': 0.0, 'std': 0.00045}, 
                              'proposal': 0.00045},
                    'TE_PolGalDust_Alpha': {'prior': {'min': -10.0, 'max': 1.0, 'mean': -2.42, 'std': 0.04},
                                             'ref': {'mean': -2.42, 'std': 0.04}, 
                                             'proposal': 0.04},
                    'TE_PolGalDust_Amp': {'prior': {'min': -1.0, 'max': 1.0, 'mean': 0.12, 'std': 0.051},
                                           'ref': {'mean': 0.12, 'std': 0.051},
                                             'proposal': 0.051},
                    'TE_PolGalDust_Beta': {'prior': {'min': -1.0, 'max': 10.0, 'mean': 1.51, 'std': 0.04}, 
                                           'ref': {'mean': 1.51, 'std': 0.04}, 
                                           'proposal': 0.04},
                    'TT_CIBClustering_Amp': {'prior': {'min': -10.0, 'max': 100.0, 'mean': 3.2263, 'std': 1.8354}, 
                                             'ref': {'mean': 3.2263, 'std': 1.8354}, 
                                             'proposal': 1.8354},
                    'TT_CIBClustering_Beta': {'prior': {'min': -10.0, 'max': 100.0, 'mean': 2.2642, 'std': 0.3814}, 
                                              'ref': {'mean': 2.2642, 'std': 0.3814}, 
                                              'proposal': 0.3814},
                    'TT_GalCirrus_Alpha': {'prior': {'min': -10.0, 'max': 1.0,'mean': -2.53, 'std': 0.05}, 
                                           'ref': {'mean': -2.53, 'std': 0.05}, 
                                           'proposal': 0.05},
                    'TT_GalCirrus_Amp': {'prior': {'min': -1.0, 'max': 10.0, 'mean': 1.88, 'std': 0.48}, 
                                         'ref': {'mean': 1.88, 'std': 0.48}, 
                                         'proposal': 0.48},
                    'TT_GalCirrus_Beta': {'prior': {'min': -1.0, 'max': 10.0, 'mean': 1.48, 'std': 0.02}, 
                                          'ref': {'mean': 1.48, 'std': 0.02}, 
                                          'proposal': 0.02},
                    'TT_Poisson_150x150': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 15.3455, 'std': 4.132}, 
                                           'ref': {'mean': 15.3455, 'std': 4.132}, 
                                           'proposal': 4.132},
                    'TT_Poisson_150x220': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 28.3573, 'std': 4.1925}, 
                                           'ref': {'mean': 28.3573, 'std': 4.1925}, 
                                           'proposal': 4.1925},
                    'TT_Poisson_220x220': {'prior': {'min': -100.0, 'max': 1000.0, 'mean': 75.9719, 'std': 14.8624}, 
                                           'ref': {'mean': 75.9719, 'std': 14.8624}, 
                                           'proposal': 14.8624},
                    'TT_Poisson_90x150': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 22.4417, 'std': 7.0881}, 
                                          'ref': {'mean': 22.4417, 'std': 7.0881}, 
                                          'proposal': 7.0881},
                    'TT_Poisson_90x220': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 20.7004, 'std': 5.9235}, 
                                          'ref': {'mean': 20.7004, 'std': 5.9235}, 
                                          'proposal': 5.9235},
                    'TT_Poisson_90x90': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 51.3204, 'std': 9.442}, 
                                         'ref': {'mean': 51.3204, 'std': 9.442}, 
                                         'proposal': 9.442},
                    'TT_kSZ_Amp': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 3.7287, 'std': 4.644}, 
                                   'ref': {'mean': 3.7287, 'std': 4.644}, 
                                   'proposal': 4.644},
                    'TT_tSZ_Amp': {'prior': {'min': -100.0, 'max': 100.0, 'mean': 3.2279, 'std': 2.3764}, 
                                   'ref': {'mean': 3.2279, 'std': 2.3764}, 
                                   'proposal': 2.3764},
                    'TT_tSZ_CIB_Corr_Amp': {'prior': {'min': -10.0, 'max': 10.0, 'mean': 0.1801, 'std': 0.3342}, 
                                            'ref': {'mean': 0.1801, 'std': 0.3342}, 
                                            'proposal': 0.3342},                    
                    'Tcal150': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.0055}, 
                                'ref': {'mean': 1.0, 'std': 0.0055}, 
                                'proposal': 0.0055},
                    'Tcal220': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.007}, 
                                'ref': {'mean': 1.0, 'std': 0.007}, 
                                'proposal': 0.007},
                    'Tcal90': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.0055}, 
                               'ref': {'mean': 1.0, 'std': 0.0055}, 
                               'proposal': 0.0055},
                    'Ecal150': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.008}, 
                                'ref': {'mean': 1.0, 'std': 0.008}, 
                                'proposal': 0.008},
                    'Ecal220': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.016}, 
                                'ref': {'mean': 1.0, 'std': 0.016}, 
                                'proposal': 0.016},
                    'Ecal90': {'prior': {'min': 0.0, 'max': 2.0, 'mean': 1.0, 'std': 0.009}, 
                               'ref': {'mean': 1.0, 'std': 0.009}, 
                               'proposal': 0.009},
}
